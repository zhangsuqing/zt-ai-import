...
import { buildRulePrompt, makeHeuristicRule, normalizeParseRule } from "@/lib/rule-engine";
...
export async function POST(request: NextRequest) {
  const body = (await request.json()) as ExtractedFile | { file?: ExtractedFile };
  const file = "file" in body && body.file ? body.file : body as ExtractedFile;
